 ...
 * @author Simulado
 */
public class EditarAjuda extends javax.swing.JFrame {
    ...
    public EditarAjuda(Ajuda ajuda) {
        this.ajuda = ajuda;
        initComponents();

        jTextField1.setText(ajuda.getTopico());
        jEditorPane1.setText(ajuda.getConteudo());

        if (ajuda.getImagem() != null) {
            jLabel3.setText("Possui imagem abra outra para alterar.");
        }
